...
function Footer(){
    return (
        ...
        <footer class="bg-gradient-to-r from-[#303030] to-[#616161] font-inter justify-center">
          <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 lg:pt-20 justify-center">
            <div class="grid grid-cols-1 gap-8 lg:grid-cols-3 font-inter">
              <div>
            ...
                    />
                ...
                <p class="max-w-md mx-auto mt-6 leading-relaxed text-regular text-center text-white sm:max-w-xs sm:mx-0 sm:text-left">
              ...
              <div
                class="grid grid-cols-1 mt-4 gap-8 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
                ...
                <div class="text-center sm:text-left font-inter">
                  <p class="text-lg font-medium text-white">Undangan Digital</p>
                ...
                <div class="text-center sm:text-left">
                  <p class="text-lg font-medium text-white">Lainnya</p>
                ...
                <div class="text-center sm:text-left">
                  <p class="text-lg font-medium text-white">Media Sosial</p>
                  <ul class="flex justify-center gap-2 mt-8 md:gap-4 sm:justify-start">
                    <li>
                      <a
                        href="/"
                  ...
                  <div className="mt-[100px] ml-28 group relative inline-block whitespace-nowrap">
                    <button className="flex size-6 cursor-pointer items-center justify-center rounded-full text-white ml-2 flex h-16 w-16 relative overflow-hidden bg-white group transition-all duration-300">
