...
function Footer(){
    return (
        <footer class="bg-gray-900 font-inter">
        <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:px-8 lg:pt-24">
          ...
                  />
            ...
            <div
              ...
              <div class="text-center sm:text-left">
                <p class="text-lg font-medium text-white">Navigasi</p>
